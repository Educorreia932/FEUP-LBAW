    ...
    <div class="col-7 col-sm-9 col-lg-10">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            ...
            @if (Auth::user()->followsMember($member->id))
                <button type="button" class="follow btn btn-primary w-100" member_username="{{ $member->username }}">
                    <i class="bi bi-heart-fill"></i>
                    <span>Following</span>
                </button>
            @else
                <button type="button" class="follow btn btn-outline-primary w-100" member_username="{{ $member->username }}">
