...
@section('content')
    ...
    <section class="container">
        ...
        <ul class="d-flex justify-content-around align-items-stretch flex-wrap list-unstyled">
            ...
            <li>
                <a class="home-category" href="{{ route("search_auctions", ["filter_check_category[]" => "game"]) }}">
                    <div>
            ...
            <li>
                <a class="home-category" href="{{ route("search_auctions", ["filter_check_category[]" => "sem"]) }}">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $cat_svg_size }}" height="{{ $cat_svg_size }}" fill="currentColor"
            ...
            <li>
                <a class="home-category" href="{{ route("search_auctions", ["filter_check_category[]" => "sftw"]) }}">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $cat_svg_size }}" height="{{ $cat_svg_size }}" fill="currentColor"
            ...
            <li>
                <a class="home-category" href="{{ route("search_auctions", ["filter_check_category[]" => "music"]) }}">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $cat_svg_size }}" height="{{ $cat_svg_size }}" fill="currentColor"
            ...
            <li>
                <a class="home-category" href="{{ route("search_auctions", ["filter_check_category[]" => "book"]) }}">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $cat_svg_size }}" height="{{ $cat_svg_size }}" fill="currentColor"
            ...
            <li>
                <a class="home-category" href="{{ route("search_auctions", ["filter_check_category[]" => "cem"]) }}">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $cat_svg_size }}" height="{{ $cat_svg_size }}" fill="currentColor"
