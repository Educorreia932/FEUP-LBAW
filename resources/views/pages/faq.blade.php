        ...
        <section class="my-2">
            ...
            <div class="p-1 ps-3">
                ...
                <div class="hover-border ps-2">
                    ...
                    <p>If you are logged in you can go <a href={{ asset('images/lbaw_offices.png') }}>here</a>, add the name and description of your item, alongside some images to help you stand out and you're good to go!</p>
                </div>
